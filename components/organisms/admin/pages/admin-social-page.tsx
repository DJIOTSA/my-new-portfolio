...
export default function AdminSocialPage() {
  ...
  const [generatingPlatform, setGeneratingPlatform] = useState<"linkedin" | "x" | null>(null);
    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-[1fr_160px_auto_auto]">
          ...
          <Button type="button" onClick={() => generate("linkedin")} className="self-end" disabled={Boolean(generatingPlatform) || isSubmitting}>
            {generatingPlatform === "linkedin" ? "Generating..." : "Generate LinkedIn"}
          </Button>
          <Button type="button" variant="outline" onClick={() => generate("x")} className="self-end" disabled={Boolean(generatingPlatform) || isSubmitting}>
            {generatingPlatform === "x" ? "Generating..." : "Generate X"}
          </Button>
        </CardContent>
      </Card>
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)}>
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button type="submit" disabled={isSubmitting || Boolean(generatingPlatform)}>
