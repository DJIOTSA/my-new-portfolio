        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={isSubmitting || isResending}>
              {isSubmitting ? (locale === "fr" ? "Connexion..." : "Signing in...") : locale === "fr" ? "Se connecter" : "Sign In"}
            </Button>
          </form>
          <div className="mt-4 flex items-center justify-between text-sm">
            ...
            >
              {isResending ? (locale === "fr" ? "Envoi..." : "Sending...") : locale === "fr" ? "Renvoyer la verification" : "Resend verification"}
            </button>
          </div>
        </CardContent>
      </Card>
