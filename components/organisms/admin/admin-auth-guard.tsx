      ...
      <div className="grid min-h-screen lg:h-screen lg:grid-cols-[260px_minmax(0,1fr)]">
        <aside className="border-r bg-white lg:sticky lg:top-0 lg:h-screen lg:overflow-y-auto">
          <div className="p-6 border-b">
            ...
            <LocaleSwitcher currentLocale={locale} onChange={setLocale} className="mt-4" />
          </div>
          ...
          <div className="p-4">
            <Button type="button" variant="outline" className="w-full justify-start" onClick={handleLogout} disabled={isSigningOut}>
              <LogOut className="w-4 h-4 mr-2" />
              {isSigningOut
                ? (locale === "fr" ? "Deconnexion..." : "Signing out...")
